...
class calling extends JFrame {
    ...
    calling(String a){
        ...
        // DP - icon no.02
        ImageIcon i444 = new ImageIcon(ClassLoader.getSystemResource("com/chatting_application/icons/astronaut.png"));
...
//===Error Thrower === === === === === === === === === === === === === === === === === === === === === === === === ===//
class Error_thrower_server1 extends JFrame{
...
class login extends JFrame {
    ...
    login() {
        ...
        b1.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    if (resultSet.next()) {
                        new Server1(x,y,z).setVisible(true);
                        setVisible(false);
                    } else {
                        Error_thrower_server1 ets = new Error_thrower_server1();
                    }
        ...
        th = new JLabel("Theme:");
        th.setBounds(600, 310, 100, 200);
        th.setFont(new Font("SANS_SERIF", Font.BOLD, 18));
        th.setForeground(Color.white);
        bg.add(th);

        r = new JTextField("7");
        r.setBounds(615, 440, 40, 30);
        r.setFont(new Font("SANS_SERIF", Font.ITALIC, 15));
        r.setForeground(Color.black);
        bg.add(r);

        g = new JTextField("94");
        g.setBounds(705, 440, 40, 30);
        g.setFont(new Font("SANS_SERIF", Font.ITALIC, 15));
        g.setForeground(Color.black);
        bg.add(g);

        b = new JTextField("84");
        b.setBounds(795, 440, 40, 30);
...
public class Server1 extends JFrame implements ActionListener {
    ...
    public Server1(int r, int g, int b) {
